 ...
 */
final class Version20230309131618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE userid userid VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plat ADD user_id VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation CHANGE userid userid VARCHAR(255) DEFAULT NULL');
    }
}
